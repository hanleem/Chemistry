...
export const MICRO_DEGREES = [
  ...
  },
  {
    ...
    completionRule: '에너지소재모델링(3) · 에너지화학(3) · 첨단에너지소재세미나(2) · 소재캡스톤디자인1(3) · 소재캡스톤디자인2(3) — 총 14학점 중 12학점 이상 취득 시 수여',
    totalCredits: 14,
    minCredits: 12,
    desc: '총 14학점 중 12학점 이상 이수 시 수여',
  },
  {
    id: 'mds_chem_analysis',
    name: '화학분석 전문자격 마이크로디그리',
    shortName: '화학분석 전문자격',
    color: '#7C3AED',
    bg: '#F3EFFE',
    requiredCourseIds: ['ac2', 'ec_ana', 'spec_ana', 'inorg_syn', 'ic_lab1'],
    allCourseIds: ['ac2', 'ec_ana', 'spec_ana', 'inorg_syn', 'ic_lab1'],
    completionRule: '분석화학2(3) · 기기분析:전기분析(3) · 기기분析:분광학(3) · 무기물및소재합성론(3) · 무기화학실험1(2) — 총 14학점 전부 이수 시 수여',
    totalCredits: 14,
    desc: '화학분석 전문 5과목(14학점) 전부 이수 시 수여',
  },
];
