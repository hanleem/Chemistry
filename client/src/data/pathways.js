...
export const MICRO_DEGREES = [
  ...
  },
  {
    ...
    completionRule: '수료 요건: 에너지소재모델링 · 에너지화학 · 첨단에너지소재세미나 · 소재캡스톤디자인1 · 소재캡스톤디자인2 — 총 14학점 중 12학점 이상 취득 시 수여',
    totalCredits: 14,
    minCredits: 12,
  ...
  },
  {
    ...
    completionRule: '수료 요건: 분석화학2 · 기기분석:전기분석 · 기기분석:분광학 · 무기물및소재합성론 · 무기화학실험1 — 총 14학점 전부 이수 시 수여',
    totalCredits: 14,
